...
const CACHE = 'orbo-v5.2.0';
const ASSETS = [
  './', './index.html', './manifest.json', './assets/icon.svg',
  './css/style.css', './css/hud.css', './css/shop.css', './css/galaxy.css', './css/v5.css', './css/v51.css', './css/v52.css',
  ...
  './js/render.js', './js/render-gear.js', './js/render-skins.js', './js/render-trails.js', './js/render-scenes.js', './js/render-gear-v51.js', './js/game.js',
  './js/ui.js', './js/ui-hud.js', './js/ui-shop.js', './js/ui-galaxy.js', './js/ui-singularity.js', './js/ui-trophies.js', './js/ui-v52.js', './js/main.js'
];
