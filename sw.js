...
const CACHE = 'orbo-v5.9.0';
const ASSETS = [
  './', './index.html', './manifest.json', './assets/icon.svg',
  './css/style.css', './css/hud.css', './css/shop.css', './css/galaxy.css', './css/v5.css', './css/v51.css', './css/v52.css', './css/v53.css', './css/v54.css', './css/v55.css', './css/v56.css', './css/v58.css', './css/story.css',
  ...
  './js/ui.js', './js/ui-hud.js', './js/ui-shop.js', './js/ui-galaxy.js', './js/ui-singularity.js', './js/ui-trophies.js', './js/ui-v52.js', './js/ui-v53.js', './js/ui-system-v54.js', './js/ui-lean-v55.js', './js/ui-perks-v56.js', './js/ui-glyph-v58.js', './js/story.js', './js/story-g1.js', './js/ui-story.js', './js/visit-mode.js', './js/main.js'
];
