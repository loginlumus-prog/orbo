...
(function () {
  ...
  const GLYPH = {
    shop: '<g class="og-cart"><path d="M2.8 4.6h2.2l1.1 3.4"/><path class="b" d="M6.3 8H21l-1.9 6.4H8.2Z"/><path d="M8.2 14.4l.6 2.2h10"/><circle cx="10" cy="19" r="1.6"/><circle cx="17.6" cy="19" r="1.6"/><path class="w og-drop" d="' + starD(13.6, 11, 2.5, 1.1, 5) + '"/></g><path class="w og-spark" d="' + sparkD(20.4, 3.8, 1.7) + '"/><path class="w og-spark s2" d="' + sparkD(4, 12.4, 1.1) + '"/>',
