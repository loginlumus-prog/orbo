...
(function () {
  ...
  add('planets', 'rare', 6, [['mars', '#d9673a', '#6b200c', '#ff8a5c', { pattern: 'planet', pl: 'mars' }], ['jupiter', '#e3c29b', '#7a4a26', '#ffd9a8', { pattern: 'planet', pl: 'jupiter', lvl: 8 }], ['uranus', '#b9f1f5', '#3e8fa0', '#bff8ff', { pattern: 'planet', pl: 'uranus', lvl: 9, decor: 'planetRing', ringTilt: 1.35, ringR: 1.58, ringW: 0.055, ringA: 0.5, ringColor: '#dff6ff', ringFront: false }], ['io', '#f2e35a', '#9a7a18', '#fff39a', { pattern: 'planet', pl: 'io', lvl: 10 }], ['europa', '#f3ece0', '#9a8c78', '#ffffff', { pattern: 'planet', pl: 'europa', lvl: 11 }], ['ganymede', '#a89a8a', '#3d342c', '#d7cbbd', { pattern: 'planet', pl: 'ganymede', lvl: 13 }]]);
